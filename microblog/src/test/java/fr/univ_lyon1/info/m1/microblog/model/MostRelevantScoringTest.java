...
public class MostRelevantScoringTest {
    ...
    void testMostRelevantScoring() {
        ...
        // When
        new MostRelevantScoring().computeScores(msgs, user);

        // Then
        assertThat(user.getMessageScore(m1.getMessageId()), is(3));
        assertThat(user.getMessageScore(m2.getMessageId()), is(8));
        assertThat(user.getMessageScore(m3.getMessageId()), is(13));
    }
}
